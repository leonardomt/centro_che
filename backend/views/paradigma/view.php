        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    ...
                    {
                        return Html::a('<button class="btn btn-danger"><i class="fa fa-trash"></i></button>',['paradigma-archivo/delete', 'id' => $model->id], ['data-confirm' => '¿Está seguro que desea eliminar este elemento?', 'data-method' =>'POST']);
                    }
                ],
            ],
