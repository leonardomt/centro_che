...
$this->params['breadcrumbs'][] = ['label' => 'Correspondencia Archivo', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
if ( Yii::$app->user->isGuest )
    return Yii::$app->getResponse()->redirect(\yii\helpers\Url::to(['site/login']));
?>
<div class="correspondencia-archivo-create col-md-12">

    <?php
    $titulo = new \backend\models\Correspondencia\Correspondencia();
    $titulo = \backend\models\Correspondencia\Correspondencia::find()->where(['id_correspondencia' => $id])->one();
