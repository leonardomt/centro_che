...
$this->title = 'Modificar Curso Online: ' . $model->titulo;
$this->params['breadcrumbs'][] = ['label' => 'Curso Online', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->titulo, 'url' => ['view', 'id' => $model->id_curso]];
...
if ( !Yii::$app->user->can('gestionar-curso-online'))
    return Yii::$app->getResponse()->redirect(\yii\helpers\Url::to(['site/login']));
?>
<div class="curso-online-update col-md-12">
            ...
            <div class="row panel-heading">
                ...
                <div class="col-lg-1">
                    <div class="form-group">
                        <?= Html::submitButton($modelClase->isNewRecord ? '<i class="fa fa-floppy-o" aria-hidden="true"></i>' : '<i class="fa fa-floppy-o" aria-hidden="true"></i>', ['class' => 'btn btn-success', 'style'=>"width: 40px; height: 40px", 'title' => 'Guardar']) ?>
                    </div>
                </div>
            </div>
