...
$this->title = 'Modificar Investigación: ' . $model->titulo_investigacion;
$this->params['breadcrumbs'][] = ['label' => 'Investigaciones', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->titulo_investigacion, 'url' => ['view', 'id' => $model->id_investigacion]];
...
if ( !Yii::$app->user->can('gestionar-investigacion'))
    return Yii::$app->getResponse()->redirect(\yii\helpers\Url::to(['site/login']));
?>
<div class="investigacion-update col-md-12">
    ...
    <div class="row panel-heading">
        ...
        <div class="col-lg-1">
            <div class="form-group">
                <?= Html::submitButton($modelArchivo->isNewRecord ? 'Guardar' : 'Modificar', ['class' => 'btn btn-primary']) ?>
            </div>
        </div>
