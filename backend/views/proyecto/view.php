                    ...
                    [
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model) {
                                return Html::a('<button title="Eliminar"  style="width: 40px; height: 40px" class="btn btn-danger"><i class="fa fa-trash"></i></button>', ['proyecto-archivo/delete', 'id' => $model->id], ['data-confirm' => '¿Está seguro que desea eliminar este elemento?', 'data-method' => 'POST']);
                            }
                        ],
                    ],
