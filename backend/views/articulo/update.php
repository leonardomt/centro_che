...
$this->title = 'Modificar Artículo: ' . $model->titulo;
...
<script>
    ...
    $(document).ready(function () {
        $(document.body).on('change', '#articulo-tipo_fecha', function () {
            var val = $('#articulo-tipo_fecha').val();
            if (val > 0) {
                $('.class').hide();
            } else {
                $('.class').show();
    ...
    $(document).ready(function () {
        $('#articulo-tipo_fecha').on('change', function () {
