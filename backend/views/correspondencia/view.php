...
<div class="correspondencia-view col-md-12">
    ...
    <p>
        <?= Html::a('Asignar Archivo', ['correspondencia-archivo/create', 'id' => $model->id_correspondencia], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Modificar', ['update', 'id' => $model->id_correspondencia], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-trash"></span>', ['delete', 'id' => $model->id_correspondencia], [
    ...
    $idnoticia = $model->id_correspondencia;?>
