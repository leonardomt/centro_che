...
$this->title = 'Create Discurso Archivo';
...
?>
<div class="discurso-archivo-create">

     <?php
    $titulo = new \backend\models\Discurso\Discurso();
    $titulo = \backend\models\Discurso\Discurso::find()->where(['id_discurso' => $id])->one();
