...
$this->params['breadcrumbs'][] = ['label' => 'Hecho-Archivo', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
if ( Yii::$app->user->isGuest )
    return Yii::$app->getResponse()->redirect(\yii\helpers\Url::to(['site/login']));
?>
<div class="hecho-archivo-create col-md-12">

   <?php
    $titulo = new \backend\models\Hecho\Hecho();
    $titulo = \backend\models\Hecho\Hecho::find()->where(['id_hecho' => $id])->one();
