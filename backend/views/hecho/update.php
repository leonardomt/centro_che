...
$this->title = 'Modificar Hecho: ' . $model->titulo;
$this->params['breadcrumbs'][] = ['label' => 'Hechos', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->titulo, 'url' => ['view', 'id' => $model->id_hecho]];
...
<div class="hecho-update col-md-12">
...
<script>
    ...
    $(document).ready(function () {
        $(document.body).on('change', '#hecho-tipo_fecha', function () {
            var val = $('#hecho-tipo_fecha').val();
            if (val > 0) {
                $('.class').hide();
            } else {
                $('.class').show();
    ...
    $(document).ready(function () {
        $('#hecho-tipo_fecha').on('change', function () {
