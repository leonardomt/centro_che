...
<div class="escrito-view">
   ...
   <div class="">
    ...
    <p>
        <?= Html::a('Asignar Archivo', ['escrito-archivo/create', 'id' => $model->id_escrito], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Modificar', ['update', 'id' => $model->id_escrito], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-trash"></span>', ['delete', 'id' => $model->id_escrito], [
                ...
                'template' => '{view} {delete}',
                 'buttons'=> [
                        ...
                        'delete' => function($url, $model) use ($idescrito) {
                            return Html::a('<span class= "glyphicon glyphicon-trash"></span>', ['escrito-archivo/delete', 'id' => $model->id_archivo, 'id2' => $idescrito], [
                            'data' => [
