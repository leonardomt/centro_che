...
$this->title = 'Crear Programación Cultural';
...
<script>
    ...
    $(document).ready(function () {
        $(document.body).on('change', '#programacion-tipo_fecha', function () {
            var val = $('#programacion-tipo_fecha').val();
            if (val > 0) {
                $('.class').hide();
            } else {
                $('.class').show();
    ...
    $(document).ready(function () {
        $('#programacion-tipo_fecha').on('change', function () {
