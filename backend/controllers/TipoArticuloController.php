...
use backend\models\Articulo\TipoArticuloSearch;
...
class TipoArticuloController extends Controller
{
    ...
    /**
     * Creates a new TipoArticulo model.
    ...
    /**
     * Updates an existing TipoArticulo model.
    ...
    /**
     * Deletes an existing TipoArticulo model.
    ...
    public function afterDeleted($id)
    {
        ...
        $log->audit_entry_model_name = 'TipoArticulo';
