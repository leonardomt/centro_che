...
class ComentarioController extends Controller
{
    ...
    public function actionCreate($id_c)
    {
        ...
        if ($model->save()) {
            $log = AuditEntryController::afterInsert($model, 'Comentarios / Responder como Institución', $model->id, $model->alias);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $log = AuditEntryController::afterUpdate( $oldmodel, $model, 'Comentarios / Gestión de Comentarios', $model->id, $model->alias);
