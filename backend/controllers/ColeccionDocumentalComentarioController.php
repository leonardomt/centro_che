...
use Yii;
use backend\models\ColeccionDocumentalComentario\ColeccionDocumentalComentario;
use backend\models\ColeccionDocumentalComentario\ColeccionDocumentalComentarioSearch;
...
class ColeccionDocumentalComentarioController extends Controller
{
    ...
    /**
     * Creates a new ColeccionDocumentalComentario model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new ColeccionDocumentalComentario();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_coleccion_documental_comentario]);
        }
    ...
    /**
     * Updates an existing ColeccionDocumentalComentario model.
    ...
    /**
     * Deletes an existing ColeccionDocumentalComentario model.
