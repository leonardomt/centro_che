...
use Yii;
use backend\models\Homenaje\Homenaje;
use backend\models\Homenaje\HomenajeSearch;
...
class HomenajeController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->setSort([
            'defaultOrder' => ['id_homenaje' => SORT_DESC],
        ]);
    ...
    public function actionDelete($id)
    {
        ...
        $temporal6 = new HomenajeArchivo();
        $temporal6 = HomenajeArchivo::find()->where(['id_homenaje' => $this->findModel($id)->id_homenaje])->all();
    ...
    public function afterDeleted($id)
    {
        ...
        $log->audit_entry_model_name = 'Homenaje';
