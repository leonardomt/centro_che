...
use backend\models\Investigacion\InvestigacionArchivoSearch;
...
class InvestigacionArchivoController extends Controller
{
    ...
    /**
     * Creates a new InvestigacionArchivo model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new InvestigacionArchivo();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_investigacion_archivo]);
        }
    ...
    /**
     * Updates an existing InvestigacionArchivo model.
    ...
    /**
     * Deletes an existing InvestigacionArchivo model.
