...
use backend\models\Homenaje\TipoHomenajeSearch;
...
class TipoHomenajeController extends Controller
{
    ...
    /**
     * Creates a new TipoHomenaje model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TipoHomenaje();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_tipo_homenaje]);
        }
    ...
    /**
     * Updates an existing TipoHomenaje model.
    ...
    /**
     * Deletes an existing TipoHomenaje model.
