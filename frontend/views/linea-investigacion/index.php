...
/* @var $searchModel frontend\models\LineaInvestigacion\LineaInvestigacionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Linea Investigaciones';
...
<div class="container text-center">
    <div class="lineainvestigacion-index">
        <div class= "option animated fadeInDown " >
            <center><h1>Líne<a id="subrayar">as de investig</a>ación</h1></center>
        </div>
        <br><br>
        <div class = "row">
