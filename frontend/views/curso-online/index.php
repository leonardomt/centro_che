...
/* @var $searchModel frontend\models\CursoOnline\CursoOnlineSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Curso Online';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="curso-online-index">
    ...
    <div class="container text-center">
        <div class="curso-online-index-index">
            <div class= "option animated fadeInDown " >
                <center><h1>Cur<a id="subrayar">sos onli</a>ne</h1></center>
            </div>
            <br><br>
            <div class = "row">
